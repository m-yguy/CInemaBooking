...
export default async function MovieDetails({
    ...
    const response = await fetch(`http://localhost:3000/api/test/${title}`, {
        cache: "no-store",
    });
    ...
    const rating = (movie as any).rating ?? "NR";
    const description = movie.movie_description ??
        "No description available.";

    const trailerLink = (movie as any).trailer_link as string | undefined;
            ...
            >
                ...
                <section style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div>
                        ...
                        <Showtimes movieTitle={movie.title} showtimes={showtimes} />
